...
export default function Hero() {
  return (
    <motion.section
      ...
      className="bg-background relative mx-auto flex h-auto w-full flex-col items-center justify-between gap-16 overflow-visible border-b border-white/10 px-4 py-24 sm:px-8 md:py-32 lg:gap-30 lg:px-18 lg:py-50 xl:flex-row"
    >
